...
class OpenAiCompatibleLlmExecutorTest {
    ...
    void throwsWhenBaseUrlMissingForUnknownProvider() {
        LlmRequest request = LlmRequest.builder()
                ...
                .agentAbout("a")
                .taskPrompt("task")
                .model(Model.of("unknown-vendor", "some-model"))
                .providerSettings(new ProviderSettings("unknown-vendor", "sk-test", null))
                .build();
    ...
    void addsStructuredResponseHintsWhenTypedResponseIsRequested() throws IOException {
        ...
        LlmRequest request = LlmRequest.builder()
                ...
                .taskPrompt("task")
                .model(Model.of("openai", "gpt-4o"))
                .responseType(Answer.class)
                .providerSettings(new ProviderSettings("openai", "sk-test", "https://example.org/v1"))
                .build();
