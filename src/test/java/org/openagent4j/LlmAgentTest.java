...
class LlmAgentTest {
    ...
    void runBuildsRequestInterpolatesInputAndDeserializesReturnType() {
        ...
        LlmAgent<WeatherResponse> weatherAgent = LlmAgent.<WeatherResponse>builder().returnType(WeatherResponse.class)
                .name("Weather Agent")
                .about(
    ...
    void runReturnsRawStringWhenReturnTypeIsStringClass() {
        LlmAgent<String> agent = LlmAgent.<String>builder().returnType(String.class)
                .name("Echo")
                .about("Echoes output.")
                .task("Say: {input}")
    ...
    void runReturnsRawStringWhenReturnTypeUnset() {
        LlmAgent<Object> agent = LlmAgent.<Object>builder()
                .name("Echo")
                .about("Echoes output.")
                .task("Hi {input}")
                .model(Model.of("test", "model"))
    ...
    void responseMethodSetsReturnType() {
        LlmAgent<String> agent = LlmAgent.<String>builder()
                .name("A")
                .about("B")
                .task("ping")
    ...
    void typedResponseIsExposedOnLlmRequest() {
        LlmAgent<WeatherResponse> agent = LlmAgent.<WeatherResponse>builder()
                .name("Typed")
    ...
    void serviceObjectRegistersAgentTools() {
        LlmAgent<String> agent = LlmAgent.<String>builder().returnType(String.class)
                ...
                .about("weather")
                .task("run tools")
                .tools(org.openagent4j.tool.ServiceTools.fromObject(new WeatherToolService()))
                .model(Model.of("x", "y"))
                .agentProperties(OpenAgentProperties.empty())
                .llmExecutor(r -> {
